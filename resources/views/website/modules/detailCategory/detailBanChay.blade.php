                    ...
                    <div id="shop-sidebar" class="sidebar-inner col-inner">
                        <aside id="yith-woo-ajax-navigation-list-price-filter-2" class="widget yith-wcan-list-price-filter yith-woocommerce-ajax-product-filter">
                            ...
                            <ul class="yith-wcan-list-price-filter">
                                <li class="price-item">
                                    @php
                                        $tentheloai = $product_category[0]['name'];
                                    @endphp
                                            ...
                                            <div class="product-small box ">
                                                <div class="box-image">
                                                    <div class="image-fade_in_back">
                                                        ...
                                                        <img width="350" height="350" src="{{asset('images/sanpham/'.$sanpham->hinhanhsanpham)}}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" decoding="async" loading="lazy" srcset="{{asset('images/sanpham/'.$sanpham->hinhanhsanpham)}}" >
                                                        <img width="350" height="350" src="{{asset('images/sanpham/'.$sanpham->hinhanhsanpham)}}" class="show-on-hover absolute fill hide-for-small back-image" alt="khoa van tay osn3362" decoding="async" loading="lazy" srcset="{{asset('images/sanpham/'.$sanpham->hinhanhsanpham)}}" >				</a>
                                                    </div>
                                                ...
                                                <div class="box-text box-text-products">
                                                    <div class="title-wrapper">
                                                        <p class="name product-title"><a href="{{route('website.detailProduct',['tensanpham' => $sanpham->tensanpham])}}">{{$sanpham->tensanpham}}</a></p>
                                                    </div>
                                                    ...
                                                    <div class="price-wrapper">
                                                        ...
                                                        <span class="price">Giá: @php echo number_format($sanpham->giasanpham) @endphp₫</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
